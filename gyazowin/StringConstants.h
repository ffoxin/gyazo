...
extern wchar_t const* const FONT_NAME;
extern wchar_t const* const POINT_FORMAT;
...
extern wchar_t const* const sTitle;
extern wchar_t const* const sWindowMainClass;
...
extern wchar_t const* const ID;
extern wchar_t const* const HEADER;
extern wchar_t const* const ID_FILENAME;
...
extern char const* const sContentId;
extern char const* const sContentData;

extern char const sCRLF[];
